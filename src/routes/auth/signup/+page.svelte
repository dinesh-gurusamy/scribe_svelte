		...
		<div class="flex flex-col gap-6">
			<Card.Root>
				<Card.Header class="text-center">
					<Card.Title class="text-xl">Welcome To Auth App</Card.Title>
					<Card.Description>Signup with your Google account</Card.Description>
				</Card.Header>
				<Card.Content>
					<form 
                    method='POST'
                    ...
                    use:enhance={() => {
						...
						<div class="grid gap-6">
							...
							Login with Apple
								...
								<button
									type="button"
									class="inline-flex w-full items-center justify-center space-x-3 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none"
